      ...
      if (!expanded) {
        const html = `
          <div style="padding:16px 20px;width:280px;">
            ...
            <a href="https://help.transporeon.com" target="_blank" style="display:block;padding:10px 0;color:#0073e6;text-decoration:none;border-bottom:1px solid #eee;">
              🔧 Transporeon Help
            </a>
          ...
          <div style="padding:16px 20px;width:260px;">
            ...
            <div style="display:flex;align-items:center;gap:10px;padding:10px 0;border-bottom:1px solid #eee;">
              ...
              <div>
                ...
                <div style="font-size:12px;color:#888;">demo@transporeon.com</div>
              </div>
            </div>
