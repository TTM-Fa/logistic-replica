...
(function () {
  ...
  function initSidebar() {
    ...
    // Find the logo area and inject "Visibility" title if missing
    const logoWrapper = header.querySelector('.n19amu5');
    let titleDiv = logoWrapper?.nextElementSibling;
    if (logoWrapper && (!titleDiv || !titleDiv.textContent.includes(''))) {
      titleDiv = document.createElement('div');
      titleDiv.textContent = 'Visibility';
